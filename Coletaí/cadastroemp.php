...
<body>
		...
		<form action="includes/cadastroemp.inc.php" method="post" class="info_txt" id="cademp" >
			...
			<input class="razao_social" type="text" name="razao" placeholder="RAZÃO SOCIAL" required>

			<span class="info_2">NOME FANTASIA*:</span>
			<input class="fantasia" type="text" name="nome_fantasia" placeholder="NOME FANTASIA" required>

			<span class="info_3">CNPJ*:</span>
			<input class="cnpj" type="number" name="cnpj" placeholder="**.***.***/****-**" required>
			...
			<input class="endereco" type="text" name="rua" placeholder="RUA" required>

			<span class="info_8">COMPLEMENTO:</span>
			<input class="endereco_comp" type="text" name="comp" placeholder="COMPLEMENTO">

			<span class="info_9">NÚMERO*:</span>
			<input class="endereco_num" type="text" name="numero" placeholder="NÚMERO" required>

			<span class="info_10">BAIRRO*:</span>
			<input class="endereco_bairro" type="text" name= "bairro" placeholder="BAIRRO" required>

			<span class="info_11">CIDADE*:</span>
			<input class="endereco_cid" type="text" name="cidade" placeholder="CIDADE" required>

			<span class="info_12">CEP*:</span>
			<input class="endereco_cep" type="text" name="cep" placeholder="12345-123" required>

			<span class="info_13">E-MAIL*:</span>
			<input class="email" type="email" name="email_emp" placeholder="exemplo@mail.com" required>

			<span class="info_14">SENHA*:</span>
			<input class="senha" type="password" name="senha_emp" placeholder="SENHA" required>
